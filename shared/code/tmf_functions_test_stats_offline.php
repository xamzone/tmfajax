...
function F_printTestStat($test_id, $group_id = 0, $user_id = 0, $startdate = 0, $enddate = 0, $testuser_id = 0, $ts = array(), $display_mode = 2, $pubmode = false)
{
    ...
    $ret .= '<td class="numeric">'.$ts['qstats']['recurrence'].' <span class="pwrap bg-fuchsia ft-white ft-sm p-2 fmono">'.F_formatPercentage($ts['qstats']['recurrence_perc'], false).'%</span></td>'.K_NEWLINE;
    $ret .= '<td class="numeric"><span class="pwrap bg-fuchsia ft-white ft-sm p-2 fmono">'.$ts['qstats']['average_score_perc'].'%</td>'.K_NEWLINE;
    $ret .= '<td class="numeric">&nbsp;'.date('i:s', $ts['qstats']['average_time']).'</td>'.K_NEWLINE;
    $ret .= '<td class="numeric">'.$ts['qstats']['right'].' <span class="pwrap bg-fuchsia ft-white ft-sm p-2 fmono">'.F_formatPercentage($ts['qstats']['right_perc'], false).'%</span></td>'.K_NEWLINE;
    $ret .= '<td class="numeric">'.$ts['qstats']['wrong'].' <span class="pwrap bg-fuchsia ft-white ft-sm p-2 fmono">'.F_formatPercentage($ts['qstats']['wrong_perc'], false).'%</span></td>'.K_NEWLINE;
    $ret .= '<td class="numeric">'.$ts['qstats']['unanswered'].' <span class="pwrap bg-fuchsia ft-white ft-sm p-2 fmono">'.F_formatPercentage($ts['qstats']['unanswered_perc'], false).'%</span></td>'.K_NEWLINE;
    $ret .= '<td class="numeric">'.$ts['qstats']['undisplayed'].' <span class="pwrap bg-fuchsia ft-white ft-sm p-2 fmono">'.F_formatPercentage($ts['qstats']['undisplayed_perc'], false).'%</span></td>'.K_NEWLINE;
    $ret .= '<td class="numeric">'.$ts['qstats']['unrated'].' <span class="pwrap bg-fuchsia ft-white ft-sm p-2 fmono">'.F_formatPercentage($ts['qstats']['unrated_perc'], false).'%</span></td>'.K_NEWLINE;
    $ret .= '</tr>'.K_NEWLINE;
    $num_module = 0;
    foreach ($ts['qstats']['module'] as $module) {
        ...
        $ret .= '<td class="numeric">'.$module['recurrence'].' <span class="pwrap bg-biru ft-white ft-sm p-2 fmono">'.F_formatPercentage($module['recurrence_perc'], false).'%</span></td>'.K_NEWLINE;
        $ret .= '<td class="numeric"><span class="pwrap bg-biru ft-white ft-sm p-2 fmono">'.($module['average_score_perc']).'%</span></td>'.K_NEWLINE;
        $ret .= '<td class="numeric">&nbsp;'.date('i:s', $module['average_time']).'</td>'.K_NEWLINE;
        $ret .= '<td class="numeric">'.$module['right'].' <span class="pwrap bg-biru ft-white ft-sm p-2 fmono">'.F_formatPercentage($module['right_perc'], false).'%</span></td>'.K_NEWLINE;
        $ret .= '<td class="numeric">'.$module['wrong'].' <span class="pwrap bg-biru ft-white ft-sm p-2 fmono">'.F_formatPercentage($module['wrong_perc'], false).'%</span></td>'.K_NEWLINE;
        $ret .= '<td class="numeric">'.$module['unanswered'].' <span class="pwrap bg-biru ft-white ft-sm p-2 fmono">'.F_formatPercentage($module['unanswered_perc'], false).'%</span></td>'.K_NEWLINE;
        $ret .= '<td class="numeric">'.$module['undisplayed'].' <span class="pwrap bg-biru ft-white ft-sm p-2 fmono">'.F_formatPercentage($module['undisplayed_perc'], false).'%</span></td>'.K_NEWLINE;
        $ret .= '<td class="numeric">'.$module['unrated'].' <span class="pwrap bg-biru ft-white ft-sm p-2 fmono">'.F_formatPercentage($module['unrated_perc'], false).'%</span></td>'.K_NEWLINE;
        $ret .= '</tr>'.K_NEWLINE;
        $ret .= '<tr>';
        ...
        if ($display_mode > 2) {
            ...
            foreach ($module['subject'] as $subject) {
                ...
                $ret .= '<td class="numeric">'.$subject['recurrence'].' <span class="pwrap bg-hijau ft-white ft-sm p-2 fmono">'.F_formatPercentage($subject['recurrence_perc'], false).'%</span></td>'.K_NEWLINE;
                $ret .= '<td class="numeric"><span class="pwrap bg-hijau ft-white ft-sm p-2 fmono">'.($subject['average_score_perc']).'%</span></td>'.K_NEWLINE;
                $ret .= '<td class="numeric">&nbsp;'.date('i:s', $subject['average_time']).'</td>'.K_NEWLINE;
                $ret .= '<td class="numeric">'.$subject['right'].' <span class="pwrap bg-hijau ft-white ft-sm p-2 fmono">'.F_formatPercentage($subject['right_perc'], false).'%</span></td>'.K_NEWLINE;
                $ret .= '<td class="numeric">'.$subject['wrong'].' <span class="pwrap bg-hijau ft-white ft-sm p-2 fmono">'.F_formatPercentage($subject['wrong_perc'], false).'%</span></td>'.K_NEWLINE;
                $ret .= '<td class="numeric">'.$subject['unanswered'].' <span class="pwrap bg-hijau ft-white ft-sm p-2 fmono">'.F_formatPercentage($subject['unanswered_perc'], false).'%</span></td>'.K_NEWLINE;
                $ret .= '<td class="numeric">'.$subject['undisplayed'].' <span class="pwrap bg-hijau ft-white ft-sm p-2 fmono">'.F_formatPercentage($subject['undisplayed_perc'], false).'%</span></td>'.K_NEWLINE;
                $ret .= '<td class="numeric">'.$subject['unrated'].' <span class="pwrap bg-hijau ft-white ft-sm p-2 fmono">'.F_formatPercentage($subject['unrated_perc'], false).'%</span></td>'.K_NEWLINE;
                $ret .= '</tr>'.K_NEWLINE;
                $ret .= '<tr>';
                ...
                if ($display_mode > 3) {
                    ...
                    foreach ($subject['question'] as $question) {
                        ...
                        $ret .= '<td class="numeric">'.$question['recurrence'].' <span class="pwrap bg-yellow ft-white ft-sm p-2 fmono">'.F_formatPercentage($question['recurrence_perc'], false).'%</span></td>'.K_NEWLINE;
                        $ret .= '<td class="numeric"><span class="pwrap bg-yellow ft-white ft-sm p-2 fmono">'.($question['average_score_perc']).'%</span></td>'.K_NEWLINE;
                        $ret .= '<td class="numeric">&nbsp;'.date('i:s', $question['average_time']).'</td>'.K_NEWLINE;
                        $ret .= '<td class="numeric">'.$question['right'].' <span class="pwrap bg-yellow ft-white ft-sm p-2 fmono">'.F_formatPercentage($question['right_perc'], false).'%</span></td>'.K_NEWLINE;
                        $ret .= '<td class="numeric">'.$question['wrong'].' <span class="pwrap bg-yellow ft-white ft-sm p-2 fmono">'.F_formatPercentage($question['wrong_perc'], false).'%</span></td>'.K_NEWLINE;
                        $ret .= '<td class="numeric">'.$question['unanswered'].' <span class="pwrap bg-yellow ft-white ft-sm p-2 fmono">'.F_formatPercentage($question['unanswered_perc'], false).'%</span></td>'.K_NEWLINE;
                        $ret .= '<td class="numeric">'.$question['undisplayed'].' <span class="pwrap bg-yellow ft-white ft-sm p-2 fmono">'.F_formatPercentage($question['undisplayed_perc'], false).'%</span></td>'.K_NEWLINE;
                        $ret .= '<td class="numeric">'.$question['unrated'].' <span class="pwrap bg-yellow ft-white ft-sm p-2 fmono">'.F_formatPercentage($question['unrated_perc'], false).'%</span></td>'.K_NEWLINE;
                        $ret .= '</tr>'.K_NEWLINE;
                        $ret .= '<tr>';
                        ...
                        if ($display_mode > 4) {
                            ...
                            foreach ($question['answer'] as $answer) {
                                ...
                                $ret .= '<td class="numeric">'.$answer['recurrence'].' <span class="pwrap bg-dark ft-white ft-sm p-2 fmono">'.F_formatPercentage($answer['recurrence_perc'], false).'%</span></td>'.K_NEWLINE;
                                $ret .= '<td class="numeric">&nbsp;</td>'.K_NEWLINE;
                                $ret .= '<td class="numeric">&nbsp;</td>'.K_NEWLINE;
                                $ret .= '<td class="numeric">'.$answer['right'].' <span class="pwrap bg-dark ft-white ft-sm p-2 fmono">'.F_formatPercentage($answer['right_perc'], false).'%</span></td>'.K_NEWLINE;
                                $ret .= '<td class="numeric">'.$answer['wrong'].' <span class="pwrap bg-dark ft-white ft-sm p-2 fmono">'.F_formatPercentage($answer['wrong_perc'], false).'%</span></td>'.K_NEWLINE;
                                $ret .= '<td class="numeric">'.$answer['unanswered'].' <span class="pwrap bg-dark ft-white ft-sm p-2 fmono">'.F_formatPercentage($answer['unanswered_perc'], false).'%</span></td>'.K_NEWLINE;
                                $ret .= '<td class="numeric">&nbsp;</td>'.K_NEWLINE;
                                $ret .= '<td class="numeric">&nbsp;</td>'.K_NEWLINE;
                                $ret .= '</tr>'.K_NEWLINE;
                                $ret .= '<tr>';
...
<a id="export_excel" download="" href="">Export Excel</a>
</div><div id="exportPDF" href="#" style="display:inline; padding-right:17px"><input type="button" id="print_export_pdf" value="Print / Export PDF"></input></div><div id="tabel_hasil_test"><html><body><p id="nm_ujian"></p><p id="kelas"></p><br/>';
    ...
    foreach ($data['testuser'] as $tu) {
        ...
        if (!$pubmode or F_getBoolean($tu['test']['test_report_to_users'])) {
            $ret .= '<td style="text-align:'.$tdalign.'"><a href="tce_show_result_user.php?testuser_id='.$tu['id'].'&amp;test_id='.$tu['test']['test_id'].'&amp;user_id='.$tu['user_id'].'" title="'.$l['h_view_details'].'">'.$tu['num'].'</a></td>'.K_NEWLINE;
        } else {
...
if($rr = F_db_query($sqlr, $db)){
	while ($mr = F_db_fetch_array($rr)){
		...
		//maman ret
        //$ret .= '<td'.$passmsg.' class="numeric">'.substr_replace(F_formatFloat($tu['total_score']), '', -1, 1).'&nbsp;'.F_formatPercentage($tu['total_score_perc'], false).'</td>'.K_NEWLINE;
		$ret .= '<td'.$passmsg.' class="numeric">'.F_formatPercentage($tu['total_score_perc'], false).'</td>'.K_NEWLINE;
        if ($stats > 0) {
	/*
	...
	*/
    ...
    $ret .= '>'.$l['w_passed'].': '.$data['passed'].' '.F_formatPercentage_2($data['passed_perc'], false).'</td>'.K_NEWLINE;
    $ret .= '</tr>';
    // print statistics
...
function F_printUserTestStat($testuser_id)
{
	...
	$jum=0;
		...
		if($m['testlog_score']>0){
            ...
            $ret .= html_entity_decode(F_decode_tcecode($m['question_description'])).K_NEWLINE;
		...
		$jml_order++;
			    ...
			    //$maman++;
				    ...
				    //$jum++;
                        ...
                        $ret .= ' ';
                        $ret .= html_entity_decode(F_decode_tcecode($ma['answer_description']));
                        if (K_ENABLE_ANSWER_EXPLANATION and !empty($ma['answer_explanation'])) {
                            $ret .= '<br /><div class="pwrap bg-biru-lt p-1 mb-10 mt-5"><span>Bobot </span><span class="pwrap bg-biru ft-white p-0 ft-xxsm">'.F_decode_tcecode($ma['answer_explanation']).'%</span></div>'.K_NEWLINE;
                        }
                        $ret .= '</li>'.K_NEWLINE;
                    }
                } else {
    ...
    //detail statistik nilai per type soal
    //gocbt
...
function F_printUserOfflineSheet($testuser_id)
{
    $maman=0;
    $jml_mcsa=0;
    $jml_mcsa_benar=0;
    ...
    require_once('../config/tce_config.php');
//    require_once('../../shared/code/tce_functions_tcecode.php');
    require_once('../../admin/code/tmf_simplehtmldom.php');
    global $db, $l;
    $testuser_id = intval($testuser_id);
	...
	$jum=0;
	    ...
	    $jum++;
            $ret .= '<li class="mb-5 m-10 brad-5 bg-white boxshd-lt hidden"><div id="headSoal" class="brad-t-5 bdb-gray1 p-10"><span>NO</span><span class="ml-5 p-3-7 brad-3 bg-biru ft-bold ft-white d-iblock txt-center">'.$jum.'</span></div>'.K_NEWLINE;
            $ret .= '<div id="qDesc" class="p-10">'.html_entity_decode($m['question_description']).'</div>'.K_NEWLINE;
            if (K_ENABLE_QUESTION_EXPLANATION and !empty($m['question_explanation'])) {
                $ret .= '<br /><span class="explanation">'.$l['w_explanation'].':</span><br />'.F_decode_tcecode($m['question_explanation']).''.K_NEWLINE;
            }
            if ($m['question_type'] == 3) {
	    ...
	    $ret .= '<div class="d-flex jc-sb ft-bold m-10 pb-10">'.K_NEWLINE;
	    $ret .= '<div id="prev" class="c-pointer d-flex jc-se p-5 brad-100 bg-biru"><span class="ft-biru brad-100 d-flex jc-se w-30 h-30 ft-xlg bg-white">&lsaquo;</span><span class="ml-5 ft-white">Sebelumnya</span></div>'.K_NEWLINE;
	    $ret .= '<div id="prevBlank"></div>'.K_NEWLINE;
	    $ret .= '<div id="next" class="c-pointer d-flex jc-se p-5 brad-100 bg-biru"><span class="mr-5 ft-white">Selanjutnya</span><span class="bg-white ft-biru brad-100 d-flex jc-se w-30 h-30 ft-xlg">&rsaquo;</span></div>'.K_NEWLINE;
	    $ret .= '</div>'.K_NEWLINE;
            $ret .= '</li>'.K_NEWLINE;
        }
        $ret .= '</ol>'.K_NEWLINE;
...
//$ret .= html_entity_decode(F_decode_tcecode($m['question_description']),ENT_QUOTES,'UTF-8').K_NEWLINE;
