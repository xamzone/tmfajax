...
echo '>Tecnick.com LTD</a> - <a href="https://mamans86.github.io/tcexam-mobile-friendly" target="blank" class="tmfpatch">tmfpatch v'.file_get_contents('../../TMFPATCHVERSION').'</a> by <a href="https://xamzone-linux.blogspot.com" target="blank" class="tmfpatch">Xamzone</a> - this site is authored by <a class="tmfpatch" href="mailto:'.K_SITE_REPLY.'">'.K_SITE_AUTHOR.'</a></span>';
