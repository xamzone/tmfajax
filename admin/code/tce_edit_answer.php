...
$thispage_title_icon = '<i class="fas fa-hat-wizard"></i> ';
...
// echo '<a class="xmlbutton" href="#answer_description" onclick="CKEDITOR.replace(\'answer_description\')">Load Editor</a>'.K_NEWLINE;
echo '<a class="xmlbutton" href="#answer_description" id="editor_btn" onclick="ckEditor(\'answer_description\',\'editor_btn\')">Load Editor</a>'.K_NEWLINE;
...
echo '<textarea name="answer_description" id="answer_description">';
echo $answer_description.'</textarea>'.K_NEWLINE;

/* echo '<script>'.K_NEWLINE;
echo '	CKEDITOR.replace(\'answer_description\');'.K_NEWLINE;
echo '</script>'.K_NEWLINE; */
...
if (K_ENABLE_ANSWER_EXPLANATION) {
    echo '<div class="row d-flex ta-left">'.K_NEWLINE;
    echo '<span class="label">'.K_NEWLINE;
    ...
    echo '<a class="xmlbutton" href="#" onclick="'.$hideexplanationarea.'" title="'.$l['w_hide'].'">'.$l['w_hide'].'</a><br/>';
    echo '<a class="xmlbutton" id="aex_btn" href="#answer_explanation" onclick="ckEditor(\'answer_explanation\',\'aex_btn\')">Load Editor</a> ';
    echo '</span>';
    echo '</span>'.K_NEWLINE;
	...
	echo '<textarea cols="50" rows="10" name="answer_explanation" id="answer_explanation">';
	echo $answer_explanation.'</textarea>'.K_NEWLINE;
	/* echo '<script>'.K_NEWLINE;
	echo '	CKEDITOR.replace(\'answer_explanation\');'.K_NEWLINE;
	echo '</script>'.K_NEWLINE; */
...
// echo '<div class="row"><hr /></div>'.K_NEWLINE;
echo '<div class="row d-flex" style="justify-content:center"><a href="tce_show_all_questions.php?order_field=question_enabled+DESC%2C+question_position%2C+question_description&subject_module_id='.$subject_module_id.'&subject_id='.$question_subject_id.'&submitted=1&firstrow=0#qid_'.$answer_question_id.'" class="xmlbutton bg-purple">< '.ucfirst($l['w_list']).'</a></div>'.K_NEWLINE;
