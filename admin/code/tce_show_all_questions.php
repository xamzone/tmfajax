...
$thispage_title_icon = '<i class="fas fa-stream"></i> ';
...
function F_show_select_questions($wherequery, $subject_module_id, $subject_id, $order_field, $orderdir, $firstrow, $rowsperpage, $hide_answers = false)
{
    ...
    if ($r = F_db_query($sql, $db)) {
        ...
        while ($m = F_db_fetch_array($r)) {
            ...
            $itemcount++;
            $questlist .= '<li class="d-flex" id="qid_'.$m['question_id'].'">'.K_NEWLINE;
            $questlist .= '<div class="d-flex fdircol ta-center narrowCol mr-10"><strong title="'.$titleStrong.'" class="d-flex jc-center liQNum mb-10 borderStd '.$bgStrong.'"><input type="checkbox" name="questionid'.$itemcount.'" id="questionid'.$itemcount.'" value="'.$m['question_id'].'" title="'.$l['w_select'].'"';
            ...
            $questlist .= '</div>';
			$questlist .= '</div>';
            $questlist .= '<div class="w-100p bg-white brad-3 borderStd"><div class="d-flex p-10">';
            ...
            if (!$hide_answers) {
                ...
                if ($ra = F_db_query($sqla, $db)) {					
                    ...
                    while ($ma = F_db_fetch_array($ra)) {
                        ...
                        $answlist .= '<li class="d-flex ai-start '.$bgRightT.'" style="padding:10px 15px"><div class="d-flex fdircol ta-center"><acronym class="black '.$bgAcro.$bgRight.'">'.$alphabet[$ansNum].'</acronym>';
                        $ansNum++;
        ...
        if (strlen($questlist) > 0) {
            ...
            echo '<input type="radio" name="checkall" id="checkall1" value="1" onclick="checkAll(\'#form_selectquestions li input[type=checkbox]\')" />';
            ...
            echo '<input type="radio" name="checkall" id="checkall0" value="0" onclick="unCheckAll(\'#form_selectquestions li input[type=checkbox]\')" />';
