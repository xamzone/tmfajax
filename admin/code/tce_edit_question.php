...
$thispage_title_icon = '<i class="fas fa-question"></i> ';
...
echo '<br />'.K_NEWLINE;
echo '<a class="xmlbutton" href="#question_description" onclick="ckEditor(\'question_description\',\'editor_btn\')" id="editor_btn">Load Editor</a>'.K_NEWLINE;
...
echo '<textarea name="question_description" id="question_description">';
echo $question_description.'</textarea>'.K_NEWLINE;


/* echo '<script>'.K_NEWLINE;
echo '	CKEDITOR.replace(\'question_description\');'.K_NEWLINE;
echo '</script>'.K_NEWLINE; */
...
if (K_ENABLE_QUESTION_EXPLANATION) {
    ...
    echo '<a class="xmlbutton" id="qex_btn" href="#question_explanation" onclick="ckEditor(\'question_explanation\',\'qex_btn\')">Load Editor</a> ';
    echo '</span>';
    echo '</span>'.K_NEWLINE;
	...
	echo '<textarea name="question_explanation" id="question_explanation" >';
    echo $question_explanation.'</textarea>'.K_NEWLINE;
    
	/* echo '<script>'.K_NEWLINE;
	echo '	CKEDITOR.replace(\'question_explanation\');'.K_NEWLINE;
	echo '</script>'.K_NEWLINE;
 */	
    echo '</span>'.K_NEWLINE;
    echo '</div>'.K_NEWLINE;
